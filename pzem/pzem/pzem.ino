...
char auth[] = "xxxxxxxxxxxxxxxxxxxxxxx";  //Blynk Token

WiFiClient client;
ThingspeakClient thingspeak;
const char* host = "api.thingspeak.com";
const String THINGSPEAK_CHANNEL_ID = "429105";
const String THINGSPEAK_API_READ_KEY = "xxxxxxxxxxxxxxxxxxxxxxx";  //read key
const char* api   = "xxxxxxxxxxxxxxxxxxxxxxx";  //write key
...
int token = 0;
String LINE_TOKEN[2]    = {"xxxxxxxxxxxxxxxxxxxxxxx", "xxxxxxxxxxxxxxxxxxxxxxx"};  //line token
